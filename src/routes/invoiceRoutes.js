...
router.put('/payment-status/:oid', [tokenUtils.verifyAccessToken, tokenUtils.isAdmin], ctrls.updatePaymentStatus);
// [PUT] Update delivery status
router.put('/delivery-status/:oid', [tokenUtils.verifyAccessToken, tokenUtils.isAdmin], ctrls.updateDeliveryStatus);
